...
registrations_by_price_band = folkschool23_26combined_1_ %>%
  mutate(
...
p = ggplot(registrations_by_price_band, aes(x = price_band, y = registrations)) +
  ...
  labs(
    ...
    title = "Registrations by Price Band",
...
ggsave(
  filename = "~/Desktop/Project/allerton-project/analysis1/price-points/registrations_by_price_band.png",
  plot = p,
  width = 8,
  height = 5,
  dpi = 300
